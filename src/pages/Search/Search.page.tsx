...
export default function Search() {
  ...
  return (
    <>
      <section className="pt-26 px-4 flex flex-col gap-2 pb-10">
      ...
      <section className="flex justify-between my-1 border-y border-neutral-300">
      ...
      <section className="grid grid-cols-4 gap-0.5 pb-6">
